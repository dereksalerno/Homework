...
class Game(object):
    ...
    def princess_lives_here(self):
        ...
        if eat_it == "eat it":
            ...
            print "The Princess screams as you cram the cake in your mouth."
    ...
    def gold_koi_pond():
        ...
        if feed_it == "feed it":
        ...
        elif feel_it == "do not feed it":
            print "The Koi grimaces, and then thrashes around for a second"
            ...
            print "You can see it's, it then grunts, thrashes..."
    ...
    def bear_with_sword():
        ...
        print "a bear wearing a load-bearing sword walks in."
